...
class Ui_Sign_Up_Dialog(object):
    def setupUi(self, Sign_Up_Dialog):
        ...
        self.loginButton.setGeometry(QtCore.QRect(200, 510, 201, 41))
        ...
        self.countryLabel = QtWidgets.QLabel(Sign_Up_Dialog)
        self.countryLabel.setGeometry(QtCore.QRect(50, 460, 201, 21))
        self.countryLabel.setStyleSheet("color:rgb(255, 255, 255); font-size:15pt;")
        self.countryLabel.setObjectName("countryLabel")
        self.pEdit_3 = QtWidgets.QLineEdit(Sign_Up_Dialog)
        self.pEdit_3.setGeometry(QtCore.QRect(290, 460, 181, 31))
        self.pEdit_3.setEchoMode(QtWidgets.QLineEdit.Password)
        self.pEdit_3.setObjectName("pEdit_3")
    ...
    def retranslateUi(self, Sign_Up_Dialog):
        ...
        self.countryLabel.setText(_translate("Sign_Up_Dialog", "Country of Residence"))
