...
class Ui_filteredResults(object):
    def setupUi(self, filteredResults):
        ...
        self.positive = QtWidgets.QPushButton(filteredResults)
        self.positive.setGeometry(QtCore.QRect(150, 110, 101, 23))
        self.positive.setStyleSheet("color: rgb(255, 255, 255)")
    ...
    def retranslateUi(self, filteredResults):
        ...
        self.positive.setText(_translate("filteredResults", "Top Positive"))
